...
## 필독 문서 (첫 턴에 Read)
- `CLAUDE.md`
- `backend/.claude/docs/reference/testing.md` (JUnit5 + Spring Boot Test)
- `web/.claude/docs/reference/testing.md` (Jest + Playwright)
- `app_flutter/.claude/docs/reference/testing.md` (widget + integration)
- `backend/.claude/docs/reference/provider-integration.md` (fake provider 사용법)
