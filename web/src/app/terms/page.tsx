...
const sections: AnchorNavItem[] = [
  { id: 'sec-1', label: '제1조 (목적)' },
  { id: 'sec-2', label: '제2조 (용어의 정의)' },
  { id: 'sec-3', label: '제3조 (약관의 효력 및 변경)' },
  { id: 'sec-4', label: '제4조 (회원가입 및 이용 계약)' },
  { id: 'sec-5', label: '제5조 (서비스의 제공 및 이용)' },
  { id: 'sec-6', label: '제6조 (결제 및 환불)' },
  { id: 'sec-7', label: '제7조 (회원의 의무)' },
  { id: 'sec-8', label: '제8조 (면책 조항)' },
  { id: 'sec-9', label: '제9조 (분쟁 해결)' },
];

export default function TermsPage() {
  return (
    <main className="mx-auto max-w-[1200px] px-6 py-16 grid md:grid-cols-[240px_1fr] gap-12">
      <AnchorNav items={sections} ariaLabel="이용약관 목차" />
      ...
      <article className="prose mx-auto w-full max-w-[720px]">
        ...
        <section id="sec-4">
          <h2>제4조 (회원가입 및 이용 계약)</h2>
          <ol>
            <li>이용 계약은 회원이 약관에 동의하고, 회사가 이를 승인함으로써 성립합니다.</li>
            <li>
        ...
        <section id="sec-6">
          ...
          <ol>
            ...
            <li>상담 예약 시 해당 상담 비용만큼의 캐시가 차감됩니다.</li>
            <li>
              환불은 다음 기준에 따릅니다:
              <ul>
