...
export default function PrivacyPage() {
  return (
    ...
    >
      ...
      <p className="mb-8" style={{ fontSize: 15 }}>
        ...
        <table className="w-full mb-4" style={{ borderCollapse: 'collapse' }}>
          ...
          <tbody style={{ fontSize: 14 }}>
            ...
            <tr>
              ...
              <td className="py-2">
                IP 주소, 접속 로그, 쿠키, 기기 정보, 서비스 이용 기록
              </td>
            </tr>
          </tbody>
        </table>
      ...
      <Section title="제5조 (개인정보의 파기)">
        <ul className="list-disc pl-5 space-y-2">
          <li>
            전자적 파일: 기록을 재생할 수 없는 기술적 방법을 사용하여 완전 삭제
          </li>
      ...
      <Section title="제6조 (이용자의 권리와 행사 방법)">
        ...
        <p className="mt-3">
          위 권리 행사는 서비스 내 설정 메뉴 또는 고객센터를 통해 가능하며, 회사는
          이에 대해 지체 없이 조치하겠습니다.
        </p>
      </Section>

      <Section title="제7조 (개인정보의 안전성 확보 조치)">
        <p className="mb-3">회사는 개인정보의 안전성 확보를 위해 다음 조치를 취하고 있습니다:</p>
        <ul className="list-disc pl-5 space-y-2">
      ...
      <Section title="제8조 (개인정보 보호책임자)">
        <ul className="space-y-1" style={{ fontSize: 14 }}>
          <li>담당부서: 개인정보보호팀</li>
        ...
        <ul className="list-disc pl-5 mt-2 space-y-1" style={{ fontSize: 14 }}>
