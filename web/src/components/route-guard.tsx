...
function AuthSkeleton() {
  return (
    <main style={{ padding: 24, display: 'grid', gap: 12 }}>
      <div style={{ height: 32, width: 160, background: 'hsl(var(--surface-2))', borderRadius: 8, animation: 'pulse 1.5s ease-in-out infinite' }} />
      <div style={{ border: '1px solid hsl(var(--border-subtle))', background: 'hsl(var(--surface))', borderRadius: 12, padding: 12 }}>
        <div style={{ height: 16, width: '60%', background: 'hsl(var(--surface-2))', borderRadius: 4, marginBottom: 10 }} />
        <div style={{ height: 16, width: '40%', background: 'hsl(var(--surface-2))', borderRadius: 4 }} />
      </div>
